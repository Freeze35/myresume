                    ...
                    >
                        <div className="text-gray-400 flex flex-col rounded-lg px-2">
                            <div className="bg-gray-900 rounded-lg p-4">
                                ...
                                <div>
                                    <a
                                        href="https://github.com/Freeze35/CRM_System"
                                ...
                                <p>
                                    Спроектировал архитектуру системы, включающую 10+ микросервисов (авторизация, чаты,
                                    таймеры, администрирование,
                                    логирование, Redis, база данных и др.), с визуализацией внутренней структуры в Figma
                                    (CRM_DIAGRAM). <br/>
                                    CRM-система на основе микросервисной архитектуры (в разработке) <br/>
                                    построенную на микросервисной архитектуре. <br/>
                                    Система включает модули авторизации, управления чатами, таймерами,
                                    администрирования, отправки писем,
                                    логирования и кэширования. <br/>
                                    Реализовал безопасное взаимодействие через gRPC и HTTPS с использованием NGINX как
                                    шлюза для маршрутизации и
                                    JWT-аутентификации. <br/>
                                    Проект направлен на упрощение процессов управления клиентами и автоматизацию задач,
                                    таких как уведомления и учет
                                    времени. <br/>
                                    ...
                                    RabbitMQ для асинхронной
                                    обработки задач (уведомления, сообщения) и Loki/Grafana для логирования и
                                    мониторинга. <br/>
                                    Реализовал меры безопасности: TLS-шифрование, JWT-аутентификация, gRPC keepalive,
                                    транзакции SQL, изоляция в
                                    Docker-сети (crm-network), и защита от паники с RecoveryInterceptor. <br/>
                                    Контейнеризировал сервисы с помощью Docker и Docker Compose, обеспечив модульность и
                                    простоту развертывания.{' '}
                                    <br/>
                                    Документировал архитектуру и микросервисы в Markdown, включая описания
                                    функциональности, эндпоинтов и мер
                                    безопасности. <br/>
                                </p>
                                <p className="text-gray-200 pr-2 py-1 sm:text-sm md:text-base lg:text-lg">Технологии</p>
                                <p>
                                ...
                                <p className="text-gray-200 pr-2 py-1 sm:text-sm md:text-base lg:text-lg">Результаты</p>
                                <p>
                                    ...
                                    Продолжаю развивать проект, добавляя новые функции (например, интеграцию с внешними
                                    API) и улучшая
                                    производительность.<br/>
                                </p>
                            </div>

                            <p className="text-gray-200 pr-2 py-2 sm:text-sm md:text-base lg:text-lg">Другие проекты</p>

                            <div className="bg-gray-900 rounded-lg p-4">
                                <p className="text-gray-200 pr-2 py-2 sm:text-sm md:text-base lg:text-lg">Онлайн-магазин</p>
                                <div>
                                    <a
                                        href="https://github.com/Freeze35/online-store"
                                ...
                                <div>
                                    <a
                                        href="https://store-petr-elshin-github-freeze35.netlify.app/shop"
                                        className="text-blue-400 hover:text-blue-500"
                                        onClick={(e) => e.stopPropagation()}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                ...
                                <p>
                                    ...
                                    из-за ограничений
                                    бесплатного хостинга.<br/>
                                    (Может быть задержка серверных данных из за деплоя на бесплатный сервер 2
                                    минуты.)<br/>
                                    Создал адаптивный интерфейс с использованием современных
                                    JavaScript-фреймворков.<br/>
                                    ...
                                    CI/CD интеграция проекта с Vercel, Netlify<br/>
                                </p>
                            </div>
                            <div className="bg-gray-900 rounded-lg p-4 mt-4">
                                ...
                                <p>
                                    ...
                                    API, обеспечивающее отправку и
                                    получение сообщений в реальном времени.<br/>
                            ...
                            <p className="text-gray-200 pr-2 py-2 sm:text-sm md:text-base lg:text-lg">P.S</p>
                            <p>
